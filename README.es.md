...
Un servicio gRPC implementado en Go para la gestión de registros article (datos maestros) con persistencia en PostgreSQL.

## Visión General

Este proyecto implementa un servicio gRPC para la gestión de registros article (datos maestros). Proporciona una arquitectura limpia con diseño basado en dominios, separación de infraestructura y pruebas comprehensivas.
...
El servicio expone una API gRPC definida en [`proto/article.proto`](proto/article.proto). Usa herramientas como `grpcurl` o `evans` para interactuar con la API.
